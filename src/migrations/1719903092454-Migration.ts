...
export class Migration1719903092454 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "borrowrecords" ADD CONSTRAINT "FK_7efd12b8973f4e65a7296a27ead" FOREIGN KEY ("bookIdId") REFERENCES "books"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "borrowrecords" DROP CONSTRAINT "FK_7efd12b8973f4e65a7296a27ead"`);
