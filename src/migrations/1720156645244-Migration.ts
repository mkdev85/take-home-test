...
export class Migration1720156645244 implements MigrationInterface {
  name = 'Migration1720156645244'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "borrowrecords" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "borrower" character varying NOT NULL, "borrowDate" date NOT NULL, "returnDate" date NOT NULL, "created_date" TIMESTAMP NOT NULL DEFAULT now(), "updated_date" TIMESTAMP NOT NULL DEFAULT now(), "bookId" uuid, CONSTRAINT "PK_8eac1c685770646267132df5dcf" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE TABLE "books" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "publishedYear" integer NOT NULL, "genre" character varying NOT NULL, "availableCopies" integer NOT NULL DEFAULT '0', "created_date" TIMESTAMP NOT NULL DEFAULT now(), "updated_date" TIMESTAMP NOT NULL DEFAULT now(), "authorId" uuid NOT NULL, CONSTRAINT "PK_f3f2f25a099d24e12545b70b022" PRIMARY KEY ("id"))`);
    await queryRunner.query(`ALTER TABLE "borrowrecords" ADD CONSTRAINT "FK_e6eb857a863b7a00bb71fad5535" FOREIGN KEY ("bookId") REFERENCES "books"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
